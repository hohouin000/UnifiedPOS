        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prefix = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<double>(type: "REAL", precision: 10, scale: 2, nullable: false),
                    PaidAmount = table.Column<double>(type: "REAL", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Options = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPrice = table.Column<double>(type: "REAL", precision: 10, scale: 2, nullable: false),
                    Subtotal = table.Column<double>(type: "REAL", precision: 10, scale: 2, nullable: false),
                    VariantDetails = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CategoryName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CategoryPrefix = table.Column<string>(type: "TEXT", maxLength: 3, nullable: true)
                },
                constraints: table =>
                {
